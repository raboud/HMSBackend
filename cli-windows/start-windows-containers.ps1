...
$env:HMS_EXTERNAL_DNS_NAME_OR_IP = "10.0.75.1"
$env:HMS_AZURE_STORAGE_CATALOG_URL ="http://10.0.75.1:5101/api/v1/catalog/items/[0]/pic/"
$env:HMS_AZURE_STORAGE_MARKETING_URL ="http://10.0.75.1:5110/api/v1/campaigns/[0]/pic/"
